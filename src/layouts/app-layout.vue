<template>
  ...
  <div class="relative">
    ...
    <div class="fixed bottom-6 ltr:right-6 rtl:left-6 z-50 no-print">
    ...
    <div
      class="main-container text-black dark:text-white-dark min-h-screen overflow-x-hidden"
      :class="[store.navbar]"
    >
      <!--  BEGIN SIDEBAR  -->
      <Sidebar />
      ...
      <div class="main-content flex flex-col">
        <!--  BEGIN TOP NAVBAR  -->
        <div
          class="absolute flex items-center justify-center top-6 left-6 p-2 bg-white-light/40 dark:bg-dark/40 hover:bg-white-light/90 dark:hover:bg-dark/60"
        >
          <a
            href="javascript:;"
            class="dark:text-[#d0d2d6] hover:text-primary dark:hover:text-primary"
            @click="store.toggleSidebar()"
          >
            <svg
              width="20"
